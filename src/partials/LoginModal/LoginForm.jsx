    ...
    return ( 
        <form onSubmit={handleSubmit}>
            <div className="relative w-full flex items-center justify-center text-black ">
                ...
                <label htmlFor="nmb" className="whitespace-nowrap text-[#717171] peer-focus:top-1 peer-focus:text-xs peer-placeholder-shown:top-4 focus:text-red-500 peer-placeholder-shown:left-3 peer-placeholder-shown:text-base/[20px] transition-all duration-200 cursor-text absolute top-1 left-3 text-xs  w-full overflow-hidden text-ellipsis">{phase == 0 ? 'E-posta' : 'Şifre'}</label>
            </div>
            <div className="mt-4">
